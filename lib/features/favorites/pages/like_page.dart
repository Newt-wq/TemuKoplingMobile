...
import 'package:temu_kopling_mobile/features/home/pages/home_screen.dart'; // Untuk MenuModel
...
class _LikePageState extends State<LikePage> {
  ...
  Widget build(BuildContext context) {
    ...
    final favoriteBrands = [
      'Semua',
      ...allFavorites.map((m) => m.brand).toSet(),
    ];
    ...
    return Scaffold(
      backgroundColor:
          AppColors.bgCream, // Sama dengan AppColors.bgCream di Home
      body: Stack(
        children: [
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text(
            'Apakah kamu yakin ingin menghapus semua daftar kopi kesukaanmu dari halaman favorit ini?',
          ),
          actions: [
            TextButton(
          ...
          children: [
            ...
            Container(
              ...
              child: const Stack(
                ...
                children: [
                  Positioned.fill(child: CircularWaveDecoration()),
                  Icon(
...
class _CircularWaveDecorationState extends State<CircularWaveDecoration>
...
class _WavePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    for (int i = 0; i < 3; i++) {
      ...
      final paint = Paint()
        ..color = AppColors.waveColor.withValues(alpha: opacity)
