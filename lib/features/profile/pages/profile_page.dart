...
import 'package:temu_kopling_mobile/features/home/pages/home_screen.dart'; // untuk FavoritesManager
...
class _ProfilePageState extends State<ProfilePage>
        ...
        child: SlideTransition(
          ...
          child: CustomScrollView(
            ...
            slivers: [
              ...
              // ===== SEKSI AKUN =====
              SliverToBoxAdapter(child: _buildSectionTitle('Akun Saya')),
              SliverToBoxAdapter(child: _buildAccountSection()),

              // ===== SEKSI PREFERENSI =====
              SliverToBoxAdapter(child: _buildSectionTitle('Preferensi')),
              SliverToBoxAdapter(child: _buildPreferenceSection()),

              // ===== SEKSI DUKUNGAN =====
              SliverToBoxAdapter(child: _buildSectionTitle('Dukungan')),
          ...
          child: Container(
            ...
            child: Stack(
              children: [
                ...
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: AppColors.bgCard.withValues(alpha: 0.06),
                    ),
                  ),
                ),
                Positioned(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      shape: BoxShape.circle,
                      color: AppColors.bgCard.withValues(alpha: 0.04),
                    ),
                  ),
                ),
                // Judul halaman
                ...
                Positioned(top: 48, right: 16, child: _buildEditButton()),
              ],
            ),
          ),
        ),
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: const Row(
          mainAxisSize: MainAxisSize.min,
          children: [
            Icon(Icons.edit_rounded, color: AppColors.bgCard, size: 14),
            SizedBox(width: 5),
            Text(
              'Edit Profil',
              style: TextStyle(
  ...
  Widget _buildStatsRow() {
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(
          color: _darkModeEnabled ? const Color(0xFF2C1E18) : AppColors.bgCard,
          borderRadius: AppRadius.radiusCard,
          boxShadow: [
            BoxShadow(
  ...
  Widget _buildStatItem(String value, String label, IconData icon) {
    return Padding(
      ...
      child: Column(
        children: [
          Icon(icon, color: AppColors.accentBrown, size: 22),
          SizedBox(height: AppSpacing.xs),
          Text(
            value,
            style: TextStyle(
    ...
    return Padding(
      ...
      child: Text(
        ...
        style: TextStyle(
          fontSize: 14,
          fontWeight: FontWeight.bold,
          color: _darkModeEnabled ? Colors.white70 : AppColors.textSecondary,
          letterSpacing: 0.8,
        ),
      ),
    );
  ...
  Widget _buildMenuItem({
    ...
    return InkWell(
      onTap: onTap,
      borderRadius: AppRadius.radiusCard,
      splashColor: AppColors.lightBrown.withValues(alpha: 0.12),
      highlightColor: AppColors.lightBrown.withValues(alpha: 0.06),
      child: Padding(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: const Row(
            ...
            children: [
              Icon(Icons.logout_rounded, color: AppColors.badgeRed, size: 20),
    ...
    final List<Map<String, String>> faqs = [
      {
        ...
        'a':
            'Pilih brand kopi terdekat di tab Home, pilih item menu yang Anda inginkan, tentukan opsi tambahan (es/gula), lalu tekan tombol Pesan. Anda dapat melacak rider yang sedang membawa pesanan Anda di tab Tracking.',
      },
      {
        'q': 'Bagaimana cara menghubungi rider?',
        'a':
            'Saat pesanan sedang dikirim, Anda dapat membuka tab Chat atau menekan tombol Chat pada panel detail rider di tab Tracking untuk mengirim pesan instan ke rider.',
      },
      {
        'q': 'Apakah aplikasi ini mendukung pengiriman di Surabaya?',
        'a':
            'Ya, saat ini Temu Kopling melayani pengiriman area Surabaya (khususnya sekitar Kampus Universitas Airlangga, Darmo, dan Wonokromo).',
      },
      {
        'q': 'Bagaimana jika pesanan tidak sesuai?',
        'a':
            'Anda dapat menggunakan fitur Hubungi Kami di halaman profil atau langsung chat dengan rider untuk berkoordinasi jika ada ketidaksesuaian.',
      },
    ];
    ...
    showModalBottomSheet(
      ...
      builder: (context) {
        return Container(
          ...
          decoration: BoxDecoration(
            color: _darkModeEnabled ? AppColors.textDark : AppColors.bgCream,
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Card(
                      ...
                      child: ExpansionTile(
                        ...
                        collapsedTextColor: _darkModeEnabled
                            ? AppColors.bgCard
                            : AppColors.textPrimary,
                        title: Text(
                          faq['q']!,
          ...
          builder: (context, setDialogState) {
            return AlertDialog(
              ...
              content: Column(
                ...
                children: [
                  const Text(
                    'Bagaimana pengalaman Anda menggunakan aplikasi Temu Kopling?',
                    style: TextStyle(
                      fontSize: 12,
                      color: AppColors.textSecondary,
                    ),
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                          'Terima kasih atas rating $selectedStars bintang Anda!',
                        ),
                        backgroundColor: AppColors.primaryBrown,
                      ),
                    );
      ...
      child: Row(
        children: [
          ...
          Switch(
            ...
            activeTrackColor: AppColors.lightBrown,
          ),
        ],
      ),
    );
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        ...
                        elevation: 4,
                        shadowColor: AppColors.primaryBrown.withValues(
                          alpha: 0.4,
                        ),
                      ),
                      child: const Text(
